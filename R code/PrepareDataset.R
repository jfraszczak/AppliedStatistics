prepareDataset<-function(dataset){
  ...
  colnames(dataset_nice_names) <- c('NUTS','Air_passengers','Hospital_beds','Deaths',
                                    'Compensation_of_employees','Deaths2','%_early_leavers_from_education',
                                    'Hours_worked','Farm_labour_force','Health_personnel','Discharges_after_respiratory_disease',
                                    'Life_expectancy','Longterm_beds','GDP','%_of_people_studying_or_training',
                                    'Population_density','Population','Students','GVA','Vehicles','Students_in_tertiary_education',
                                    'Unemployement_rate','Utilised_agricoltural_area','%_of_NEET','First_wave_density',
                                    'Second_wave_density','Country','Longitude','Latitude')
  
  dataset_nice_names <- dataset_nice_names[c('NUTS','Country','Population','Population_density','Students_in_tertiary_education','%_early_leavers_from_education',
                                             '%_of_NEET','%_of_people_studying_or_training','Students','Life_expectancy','Deaths',
